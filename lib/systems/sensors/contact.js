  ...
  render() {
    ...
    return (
      <g>
        ...
        <circle className="contact" key={contact.id} cx={contact.position.x} cy={contact.position.y} r="5" stroke="none" fill="yellow" onMouseDown={e => this.onContactMouseDown(e, contact)}/>
      </g>
    )
  }
}
